...
class FormularioCadastroProduto extends react_1.Component {
    constructor(props) {
        super(props);
        this.state = {
            nome: '',
