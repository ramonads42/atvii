...
import CPF from "../modelo/cpf"; // Necessário para criar Cliente
import RG from "../modelo/rg"; // Se for usar RG
import Telefone from "../modelo/telefone"; // Se for usar Telefone
